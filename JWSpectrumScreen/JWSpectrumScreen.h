...
- (id)initWithRepresentation:(CGImageRef)rep mode:(ScreenMode)screenMode hiResMode:(TimexHiResMode)hiMode;


// Loads a screen file - called by initWithContentsOfURL:
// Returns YES on success, otherwise NO.
- (BOOL)loadScreenFile:(NSURL*)url;

// Loads a snapshot file - called by initWithContentsOfURL:
// Returns YES on success, otherwise NO.
- (BOOL)loadSnapshot:(NSURL*)url;


// Returns an CGImageRef so you can draw the screen on a Mac.
